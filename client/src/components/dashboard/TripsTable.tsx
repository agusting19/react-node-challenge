...
export function TripsTable({
  ...
  const renderTableBody = () => {
    ...
    return trips.map((trip) => <TripRow key={trip.id} trip={trip} />);
  };
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="hidden lg:table-cell">Litros</TableHead>
              <TableHead className="hidden lg:table-cell">Salida</TableHead>
